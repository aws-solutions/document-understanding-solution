...
(ENABLE_KENDRA? ` traditional search based technologies such as Amazon Elasticseach (Amazon ES) as well using state-of-the-art machine learning and natural language enterprise search
with Amazon Kendra.`: `Amazon Elasticsearch`) +
`

Once you select a document, you'll be able to interact with Amazon Textract` + 
(ENABLE_COMPREHEND_MEDICAL? `
, Amazon Comprehend and Amazon Comprehend Medical` :`
 and Amazon Comprehend`) +
`
to experience the power of document digitization and extraction of sensitive information.` +
(ENABLE_KENDRA?
`
