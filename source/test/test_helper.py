...
class TestS3Helper(unittest.TestCase):
    def setUp(self):
        ...
        self.conn.create_bucket(Bucket=BUCKET_NAME, CreateBucketConfiguration={
    ...
    def test_write_to_s3(self):
        ...
        body = self.conn.Object(BUCKET_NAME, S3_FILE_NAME).get()[
...
class TestDynamoDBHelper(unittest.TestCase):
    ...
    def test_insert_item(self):
        ...
        self.assertEqual(
            ddbResponse['ResponseMetadata']['HTTPStatusCode'], 200)
