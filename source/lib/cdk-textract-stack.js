...
class CdkTextractStack extends cdk.Stack {
    ...
    constructor(scope, id, props) {
        ...
        const oai = new aws_cloudfront_1.OriginAccessIdentity(this, "cdk-textract-oai", {
        ...
        const esLogGroup = new aws_logs_1.LogGroup(this, this.resourceName("ElasticSearchLogGroup"), {
        ...
        if (!props.isCICDDeploy) {
            ...
            const serviceLinkedRole = new cdk.CfnResource(this, this.resourceName("es-service-linked-role"), {
        ...
        const cognitoPolicy = new iam.Policy(this, "textract-cognito-policy", {
            statements: [
                new iam.PolicyStatement({
                    ...
                    resources: [
                        `arn:aws:cognito-identity:${CdkTextractStack.of(this).region}:${CdkTextractStack.of(this).account}:identitypool/${textractIdentityPool.ref}`,
                    ],
                    effect: iam.Effect.ALLOW,
                }),
                new iam.PolicyStatement({
        ...
        const cicdBotoLoc = lambda.Code.fromBucket(s3.Bucket.fromBucketName(this, "solutionBucketBoto", "SOURCE_BUCKET"), "SOLUTION_NAME/CODE_VERSION/boto3-layer.zip");
        const cicdPDFLoc = lambda.Code.fromBucket(s3.Bucket.fromBucketName(this, "solutionBucketPDF", "SOURCE_BUCKET"), "SOLUTION_NAME/CODE_VERSION/searchable-pdf-1.0.jar");
