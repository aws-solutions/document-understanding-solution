...
const cloudformationDescribe = `aws cloudformation describe-stack-resources --region eu-west-1 --stack-name ${stackName}`
...
const GetResources = new Promise((resolve, reject) => {
  ...
  cf.describeStackResources(
    ...
    (err, resp) => {
      ...
      resources.ClientAppBucketName = stackDescriptionObj.StackResources.find(x =>
